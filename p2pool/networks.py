...
nets = dict(
    ...
    myriadcointestnet=math.Object(
        PARENT=networks.nets['myriadcoin_testnet'],
    ...
    myriadcoin=math.Object(
        ...
        PERSIST=True,
        WORKER_PORT=3333,
        BOOTSTRAP_ADDRS='birdspool.no-ip.org aforis.mooo.com us.myriadminers.com eu.myriadminers.com nz.p2pool.geek.nz uk.p2pool.geek.nz meziti.nl'.split(' '),
        #ANNOUNCE_CHANNEL='#cryptopools-p2p',
        VERSION_CHECK=lambda v: True,
    ),
